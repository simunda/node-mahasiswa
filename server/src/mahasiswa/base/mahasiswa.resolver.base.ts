...
export class MahasiswaResolverBase {
  ...
  async createMahasiswa(
    ...
    return await this.service.create({
      ...
      data: {
        ...
        dosenpa: args.data.dosenpa
          ? {
              connect: args.data.dosenpa,
            }
          : undefined,
      },
    });
  ...
  async dosenpa(@graphql.Parent() parent: Mahasiswa): Promise<Dosen | null> {
    const result = await this.service.getDosenpa(parent.id);
